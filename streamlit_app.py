...
def download_similarity_file():
    if not os.path.exists('similarity.pkl'):
        ...
        gdown.download('https://drive.google.com/uc?export=download&id=1ryKP6k1EYdBUTKMThTDChFt_GRRsSj_B', 'similarity.pkl', quiet=False)
...
# Download the similarity.pkl file if it's not already present
